...
const styles = {
  ...
  greeting: { fontSize: 22, fontWeight: 800, color: "#1a1a2e", margin: 0 },
  subtitle: { color: "#888", margin: "4px 0 0", fontSize: 13 },
  exportBtn: { background: "linear-gradient(135deg, #43e97b, #38f9d7)", color: "white", border: "none", borderRadius: 12, padding: "10px 16px", fontWeight: 700, cursor: "pointer", fontSize: 13 },
  statsGrid: { display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 12, marginBottom: 24 },
  statCard: { background: "white", borderRadius: 16, padding: "16px", boxShadow: "0 4px 20px rgba(0,0,0,0.08)" },
  statValue: { fontSize: 22, fontWeight: 800, marginBottom: 4 },
  statLabel: { color: "#888", fontSize: 12 },
  section: { background: "white", borderRadius: 16, padding: "16px", marginBottom: 16, boxShadow: "0 4px 20px rgba(0,0,0,0.08)" },
  sectionTitle: { fontSize: 16, fontWeight: 700, color: "#1a1a2e", marginTop: 0, marginBottom: 12 },
  empty: { color: "#aaa", textAlign: "center", padding: "20px 0", fontSize: 14 },
  taskList: { display: "flex", flexDirection: "column", gap: 8 },
  taskItem: { display: "flex", alignItems: "center", gap: 8, padding: "10px 12px", background: "#f8f9ff", borderRadius: 10, flexWrap: "wrap" },
  badge: { padding: "3px 8px", borderRadius: 20, fontSize: 11, fontWeight: 600 },
  taskTitle: { flex: 1, fontWeight: 500, color: "#333", fontSize: 14, minWidth: 100 },
  priority: { fontSize: 11, fontWeight: 700, textTransform: "uppercase" },
  journalItem: { display: "flex", alignItems: "center", gap: 8, padding: "10px 12px", background: "#f8f9ff", borderRadius: 10, flexWrap: "wrap" },
  journalDate: { color: "#667eea", fontWeight: 600, fontSize: 12, minWidth: 80 },
  journalText: { flex: 1, color: "#555", fontSize: 12, minWidth: 100 },
  score: { color: "#f093fb", fontWeight: 700, fontSize: 12 }
};