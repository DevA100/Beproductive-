...
const styles = {
  ...
  input: { width: "100%", padding: "12px 14px", border: "2px solid #eee", borderRadius: 10, fontSize: 14, outline: "none", boxSizing: "border-box", marginBottom: 12 },
  ...
  challengeTag: { background: "#a78bfa20", color: "#a78bfa", padding: "4px 12px", borderRadius: 20, fontSize: 13, fontWeight: 600 },
  editBtn: { background: "#667eea20", color: "#667eea", border: "none", borderRadius: 8, padding: "4px 10px", cursor: "pointer", fontSize: 12, fontWeight: 600 },
